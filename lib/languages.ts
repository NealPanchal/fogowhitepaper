...
● Consenso multilocal con colocación dinámica, que logra tiempos de bloque y latencias mucho más bajos a los de cualquier blockchain principal.
...
Esto crea una selección natural para la implementación del cliente más eficiente. En el entorno de colocación de Fogo, incluso las pequeñas diferencias de rendimiento se vuelven significativas: un cliente ligeramente más lento tendrá un rendimiento inferior al esperado, lo que provocará la pérdida de bloques y penalizaciones. Esta optimización se produce por interés propio del validador, no por las reglas del protocolo.
